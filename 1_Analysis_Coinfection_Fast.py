...
plt.savefig('figs/1_EpiCurves_fast.pdf')
plt.show()

plt.figure(figsize=(10,8))
for i in range(pars['nv']):
    plt.plot(t, sol1[:, i], label = '$S_{%i}$' % i,  color = sns.color_palette(cmap, pars['nv'])[i], linewidth = 3)
#plt.legend(loc='best', fontsize = 14)
...
plt.xticks(fontsize = 16)
plt.yticks(fontsize = 16)
plt.savefig('figs/1_SusceptibleCurves_fast.pdf')
plt.show()
...
plt.xticks(fontsize = 16)
plt.yticks(fontsize = 16)
plt.savefig('figs/1_FreqCurves_fast.pdf')
plt.show()
#plt.legend()
...
plt.savefig('figs/1_Infecteds_fast.pdf')
plt.show()
...
plt.savefig('figs/1_NumberStrains_fast.pdf')
plt.show()
...
plt.savefig('figs/1_ValuesR0_fast.pdf')
plt.show()
...
plt.savefig('figs/1_DomStrain_R0_fast.pdf')
plt.show()