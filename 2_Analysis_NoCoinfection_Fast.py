...
plt.savefig('figs/2_EpiCurves_fast.pdf')
plt.show()
...
plt.xticks(fontsize = 16)
plt.yticks(fontsize = 16)
plt.savefig('figs/2_SusceptibleCurves_fast.pdf')
plt.show()
...
plt.xticks(fontsize = 16)
plt.yticks(fontsize = 16)
plt.savefig('figs/2_FreqCurves_fast.pdf')
plt.show()
#plt.legend()
...
plt.savefig('figs/2_Infecteds_fast.pdf')
plt.show()
...
plt.savefig('figs/2_NumberStrains_fast.pdf')
plt.show()
...
plt.savefig('figs/2_ValuesR0_fast.pdf')
plt.show()
...
plt.savefig('figs/2_DomStrain_R0_fast.pdf')
plt.show()