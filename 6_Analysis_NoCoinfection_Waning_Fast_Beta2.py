...
plt.savefig('figs/6_EpiCurves_0p5_2_fast_beta2.pdf')   
plt.show()
...
plt.xticks(fontsize = 16)
plt.yticks(fontsize = 16)
plt.savefig('figs/6_SusceptibleCurves_0p5_2_fast_beta2.pdf')
plt.show()
...
plt.xticks(fontsize = 16)
plt.yticks(fontsize = 16)
plt.savefig('figs/6_FreqCurves_0p5_2_fast_beta2.pdf')
plt.show()
#plt.legend()
...
plt.savefig('figs/6_Infecteds_0p5_2_fast_beta2.pdf')
plt.show()
...
plt.savefig('figs/6_NumberStrains_0p5_2_fast_beta2.pdf')
plt.show()
...
plt.savefig('figs/6_ValuesR0_0p5_2_fast_beta2.pdf')
plt.show()
