...
def quad_beta_positive(x):
    return -((3/(50**2))*((x-50)**2)) +4
...
for i in range(pars['nv']):
    ...
    plt.plot(t[:], sol1[:, pars['nv']+i], label = '$I_{%i}$' % (i+1), linewidth = 3, color = sns.color_palette(cmap, pars['nv'])[i])
#plt.legend(loc='best', fontsize = 14)
plt.xlabel('Time (days)', fontsize = 18)
plt.ylabel(r'$I_i$', fontsize = 18)
plt.xticks(fontsize = 16)
plt.yticks(fontsize = 16)
plt.savefig('figs/6_EpiCurves_0p5_2_fast_beta1.pdf')   
plt.show()
...
plt.xticks(fontsize = 16)
plt.yticks(fontsize = 16)
plt.savefig('figs/6_SusceptibleCurves_0p5_2_fast_beta1.pdf')
plt.show()
...
plt.xticks(fontsize = 16)
plt.yticks(fontsize = 16)
plt.savefig('figs/6_FreqCurves_0p5_2_fast_beta1.pdf')
plt.show()
#plt.legend()
...
ax2.axhline(y = np.log(100), linestyle='--', linewidth = 3, color = 'red', label = 'log(N = Nf)')
plt.legend(fontsize = 16)
plt.savefig('figs/6_Infecteds_0p5_2_fast_beta1.pdf')
plt.show()
...
plt.savefig('figs/6_NumberStrains_0p5_2_fast_beta1.pdf')
plt.show()
...
plt.yticks(fontsize = 16)
plt.legend(fontsize = 16)
plt.savefig('figs/6_ValuesR0_0p5_2_fast_beta1.pdf')
plt.show()
...
plt.savefig('figs/6_DomStrain_R0_0p5_2_fast_beta1.pdf')
plt.show()
...
plt.xticks(fontsize = 16)
plt.yticks(fontsize = 16)
plt.savefig('figs/6_Endemic_0p5_2_fast_beta1.pdf')
plt.show()