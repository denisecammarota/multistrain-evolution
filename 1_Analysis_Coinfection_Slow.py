...
plt.savefig('figs/1_EpiCurves_slow.pdf')
plt.show()
...
plt.xticks(fontsize = 16)
plt.yticks(fontsize = 16)
plt.savefig('figs/1_SusceptibleCurves_slow.pdf')
plt.show()
...
plt.xticks(fontsize = 16)
plt.yticks(fontsize = 16)
plt.savefig('figs/1_FreqCurves_slow.pdf')
plt.show()
#plt.legend()
...
plt.savefig('figs/1_Infecteds_slow.pdf')
plt.show()
...
plt.savefig('figs/1_NumberStrains_slow.pdf')
plt.show()
...
plt.savefig('figs/1_ValuesR0_slow.pdf')
plt.show()
...
plt.savefig('figs/1_DomStrain_R0_slow.pdf')
plt.show()
...
plt.xticks(fontsize = 16)
plt.yticks(fontsize = 16)
plt.savefig('figs/1_Endemic_slow.pdf')
plt.show()