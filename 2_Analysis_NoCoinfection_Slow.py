...
plt.savefig('figs/2_EpiCurves_slow.pdf')
plt.show()
...
plt.xticks(fontsize = 16)
plt.yticks(fontsize = 16)
plt.savefig('figs/2_SusceptibleCurves_slow.pdf')
plt.show()
...
plt.xticks(fontsize = 16)
plt.yticks(fontsize = 16)
plt.savefig('figs/2_FreqCurves_slow.pdf')
plt.show()
#plt.legend()
...
plt.savefig('figs/2_Infecteds_slow.pdf')
plt.show()
...
plt.savefig('figs/2_NumberStrains_slow.pdf')
plt.show()
...
plt.savefig('figs/2_ValuesR0_slow.pdf')
plt.show()
...
plt.savefig('figs/2_DomStrain_R0_slow.pdf')
plt.show()
...
plt.xticks(fontsize = 16)
plt.yticks(fontsize = 16)
plt.savefig('figs/2_Endemic_slow.pdf')
plt.show()