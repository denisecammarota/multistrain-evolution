...
plt.savefig('figs/3_EpiCurves_40_slow.pdf')
plt.show()
...
plt.xticks(fontsize = 16)
plt.yticks(fontsize = 16)
plt.savefig('figs/3_SusceptibleCurves_40_slow.pdf')
plt.show()
...
plt.xticks(fontsize = 16)
plt.yticks(fontsize = 16)
plt.savefig('figs/3_FreqCurves_40_slow.pdf')
plt.show()
#plt.legend()
...
plt.savefig('figs/3_Infecteds_40_slow.pdf')
plt.show()
...
plt.savefig('figs/3_NumberStrains_40_slow.pdf')
plt.show()
...
plt.savefig('figs/3_ValuesR0_40_slow.pdf')
plt.show()
