...
plt.savefig('figs/7_EpiCurves_40_slow_beta1.pdf')   
plt.show()
...
plt.xticks(fontsize = 16)
plt.yticks(fontsize = 16)
plt.savefig('figs/7_SusceptibleCurves_40_slow_beta1.pdf')
plt.show()
...
plt.xticks(fontsize = 16)
plt.yticks(fontsize = 16)
plt.savefig('figs/7_FreqCurves_40_slow_beta1.pdf')
plt.show()
#plt.legend()
...
plt.savefig('figs/7_Infecteds_40_slow_beta1.pdf')
plt.show()
...
plt.savefig('figs/7_NumberStrains_40_slow_beta1.pdf')
plt.show()
...
plt.savefig('figs/7_ValuesR0_40_slow_beta1.pdf')
plt.show()
...
plt.savefig('figs/7_DomStrain_R0_40_slow_beta1.pdf')
plt.show()
...
plt.xticks(fontsize = 16)
plt.yticks(fontsize = 16)
plt.savefig('figs/7_Endemic_40_slow_beta1.pdf')
plt.show()
